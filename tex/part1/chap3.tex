...
\begin{table}[!ht]
    \centering
    \caption{Average OBS-BAU and year-to-year estimate (in percentage) of ORG data and RPRO data from February 24 to July 31, 2022, for the nine most populous cities in Ukraine. The values are represented as mean (with standard deviation in parentheses). The mean and standard deviation in the last row were calculated across the nine cities.}
    \label{tab:tab5}
    \begin{tabular}{c c c c c }
        \hline
...
\subsection{S5P NO2 level changes in the most populous cities of Ukraine}
