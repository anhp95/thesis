...
\begin{table}[!ht]
    \centering
    \caption[S5P NO2 change during February-July, 2022 in populous cities]{Average OBS-BAU and year-to-year estimate (in percentage) of ORG data and RPRO data from February 24 to July 31, 2022, for the nine most populous cities in Ukraine. The values are represented as mean (with standard deviation in parentheses). The mean and standard deviation in the last row were calculated across the nine cities.}
    \begin{tabular}{c c c c c }
        \hline
